...
function HelloPerlService(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.hello = function (message, _callback, _errorCallback) {
        if (typeof message === 'function')
            throw 'Argument message can not be a function';
        ...
        return json_call_ajax(_url, "HelloPerlService.hello",
            [message], 1, _callback, _errorCallback);
    };
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "HelloPerlService.status",
